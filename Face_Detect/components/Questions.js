...
class Questions extends Component {
            ...
            <View>
                <View style={styles.header}>
                    <Text style={styles.h1}>
                     Questions No {this.state.number + 1}</Text>
                ...
                <Card>
                    <Button color='black' title="Exit Trivia Quiz" onPress={this.finish} />
                </Card>
            </View>
        );
    };
    ...
    nextQuestion(answer) {
      const {number,data,score} =this.state;
        console.log("Question Number", number);
        if (number == 6 + 2) {
            this.finish();
        }
        console.log("My answer is :", answer);
        let correct = data[number].correct_answer == "True";
